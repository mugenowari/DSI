...
class HomeApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: DSIHomePage(title: 'HomeScreen'),
    );
  }
}

class DSIHomePage extends StatefulWidget {
  final String title;

  DSIHomePage({Key key, this.title}) : super(key: key);

  @override
  _DSIHomePageState createState() => _DSIHomePageState();
}

class _DSIHomePageState extends State<DSIHomePage> {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Row(
          ...
          child: RaisedButton(
            onPressed: _prevtela,
            child: Image(image: AssetImage('images/setaw.png'), height: 32),
          ),
          ),
            Spacer(),
            Text(widget.title),
