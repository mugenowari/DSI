...
class Professor {
  ...
  Professor({this.id, this.matricula, this.pessoa, this.salario, this.telefone, this.email});
  ...
  Map<String, dynamic> toJson() => {'matricula': matricula, 'salario': salario, 'telefone': telefone, 'email': email};
}
